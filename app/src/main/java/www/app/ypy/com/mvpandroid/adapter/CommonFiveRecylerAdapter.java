...
public abstract class CommonFiveRecylerAdapter<T> extends RecyclerView.Adapter<CommonRecylerHolder> {
    ...
    public CommonFiveRecylerAdapter(Context context, List<T> list, int itemLayoutId) {
