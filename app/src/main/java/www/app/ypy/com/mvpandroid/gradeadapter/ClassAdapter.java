...
public class ClassAdapter {
    ...
    public ClassAdapter(List<InforBean.MainTeacherClazzBean> classNameOrSubjectLists, Context context, int searchTag) {
        classNameOrSubjectList.clear();
        classNameOrSubjectList.addAll(classNameOrSubjectLists);
    ...
    public void getSuccessData(List<InforBean.MainTeacherClazzBean> classNameOrSubject, int serachTag) {
        classNameOrSubjectList.clear();
        classNameOrSubjectList.addAll(classNameOrSubject);
